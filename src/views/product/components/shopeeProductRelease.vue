<template>
  <div class="history">
      <a-row style="margin-bottom:20px">
        <a-col :md="5" :lg="8" :xl="6" :xxl="4" class='' v-show='showUploadBtn === true'>
        ...
        <a-col  style="float:right" :md="7" :lg="5" :xl="4" :xxl="2">
      ...
      <a-row>
        <a-col :md="12" :lg="10" :xl="8" :xxl="6">
          <a-button-group>
            <a-button :type='screenType ==="0" ? "primary":""'  @click='screen("0")'>待发布</a-button>
            <a-button  :disabled='!hasPerm(permsBtn.history_loding)'  :type='screenType ==="1" ? "primary":""' @click='screen("1")'>发布中</a-button>
            <a-button  :disabled='!hasPerm(permsBtn.history_success)' :type='screenType ==="2" ? "primary":""' @click='screen("2")'>已发布</a-button>
            <a-button :disabled='!hasPerm(permsBtn.history_error)' :type='screenType ==="3" ? "primary":""' @click='screen("3")'>发布失败</a-button>
          </a-button-group>
        </a-col>
      </a-row>
      <a-row class='mt'>
              ...
              <span>
                <a-row>
                  <a-col v-if='condition==="0" || record.endResult === "3"' :span="12">
                    <a-button  type='primary'  style="margin-left:10px"   @click='Edits(record.top_goods_id,"amazon")' >编辑</a-button>
                  </a-col>
